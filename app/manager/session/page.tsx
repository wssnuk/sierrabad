        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-indigo-300">
            ...
            <div className="grid sm:grid-cols-2 gap-3 mt-4">
              <form action={sendLineNow.bind(null, session.id)}>
                <button
                  type="submit"
                  className="w-full py-4 rounded-2xl bg-gradient-to-r from-emerald-600 to-emerald-500 text-white font-bold text-base shadow-lg shadow-emerald-200 hover:shadow-xl transition-all"
                >
                  ส่งสรุปเข้า LINE
                </button>
              </form>
              <form action={closeSession.bind(null, session.id)}>
                <button
                  type="submit"
                  className="w-full py-4 rounded-2xl bg-gradient-to-r from-purple-600 to-purple-500 text-white font-bold text-base shadow-lg shadow-purple-200 hover:shadow-xl transition-all"
                >
                  ปิดก๊วน
                </button>
              </form>
